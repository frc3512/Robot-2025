...
public class Robot extends TimedRobot {
  ...
  public Robot() {
    ...
    appendageJoystick
        .button(10)
        .onTrue(new InstantCommand(() -> reeftake.prossecer()))
        .onFalse(
    ...
    appendageJoystick.button(8).onTrue(a1()).onFalse(rectractAlgae());

    appendageJoystick.button(7).onTrue(a2()).onFalse(rectractAlgae());
