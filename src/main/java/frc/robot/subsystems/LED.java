...
public class LED extends SubsystemBase {
  ...
  public final LEDPattern left = LEDPattern.steps(Map.of(0, Color.kRed, 0.5, Color.kWhite));
  public final LEDPattern right = LEDPattern.steps(Map.of(0, Color.kBlue, 0.5, Color.kWhite));
